...
*ATTENTION: This README is out of date. It describes the old ankidoc shell
script. The README will be updated in the near future, but if you just want to
use the old process described here, use commit b3ee942 or earlier.*
